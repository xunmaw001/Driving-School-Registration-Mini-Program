...
public class KechenganpaiController {
    ...
    public R page(@RequestParam Map<String, Object> params,KechenganpaiEntity kechenganpai,
		...
		if(tableName.equals("yonghu")) {
			kechenganpai.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaxiaojiaolian")) {
			kechenganpai.setJiaolianzhanghao((String)request.getSession().getAttribute("username"));
		}
