  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaxiaojiaolian'"  label="教练姓名" prop="jiaolianxingming">
          <el-input v-model="ruleForm.jiaolianxingming"               placeholder="教练姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaxiaojiaolian'"  label="教练账号" prop="jiaolianzhanghao">
          <el-input v-model="ruleForm.jiaolianzhanghao" readonly              placeholder="教练账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaxiaojiaolian'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaxiaojiaolian'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='jiaxiaojiaolian'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaxiaojiaolian'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaxiaojiaolian'"  label="通过率" prop="tongguolv">
          <el-input v-model="ruleForm.tongguolv"               placeholder="通过率" clearable></el-input>
        </el-form-item>
      </el-col>
