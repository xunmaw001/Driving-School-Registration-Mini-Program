<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考试类型" prop="kaoshileixing">
          <el-input v-model="ruleForm.kaoshileixing" 
              placeholder="考试类型" clearable  :readonly="ro.kaoshileixing"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kaoshibaoming/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kaoshibaomingCrossAddOrUpdateFlag = false;
						 this.parent.search();
