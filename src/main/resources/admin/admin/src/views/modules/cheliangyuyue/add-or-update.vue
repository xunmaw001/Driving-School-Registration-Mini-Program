<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车辆位置" prop="cheliangweizhi">
          <el-input v-model="ruleForm.cheliangweizhi" 
              placeholder="车辆位置" clearable  :readonly="ro.cheliangweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车辆位置" prop="cheliangweizhi">
              <el-input v-model="ruleForm.cheliangweizhi" 
                placeholder="车辆位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `cheliangyuyue/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.cheliangyuyueCrossAddOrUpdateFlag = false;
						 this.parent.search();
