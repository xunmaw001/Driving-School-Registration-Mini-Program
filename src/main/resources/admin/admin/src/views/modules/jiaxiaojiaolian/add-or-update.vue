<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="通过率" prop="tongguolv">
          <el-input v-model="ruleForm.tongguolv" 
              placeholder="通过率" clearable  :readonly="ro.tongguolv"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="通过率" prop="tongguolv">
              <el-input v-model="ruleForm.tongguolv" 
                placeholder="通过率" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gerenjieshao = this.ruleForm.gerenjieshao.replace(reg,'../../../springboot22c8q/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
