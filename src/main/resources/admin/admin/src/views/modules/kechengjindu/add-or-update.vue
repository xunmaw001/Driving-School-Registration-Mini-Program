    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学习时长" prop="xuexishizhang">
          <el-input v-model="ruleForm.xuexishizhang" 
              placeholder="学习时长" clearable  :readonly="ro.xuexishizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学习时长" prop="xuexishizhang">
              <el-input v-model="ruleForm.xuexishizhang" 
                placeholder="学习时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="学习进度" prop="xuexijindu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xuexijindu" label="学习进度" prop="xuexijindu">
                    <span v-html="ruleForm.xuexijindu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xuexijindu = this.ruleForm.xuexijindu.replace(reg,'../../../springboot22c8q/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kechengjindu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kechengjinduCrossAddOrUpdateFlag = false;
						 this.parent.search();
