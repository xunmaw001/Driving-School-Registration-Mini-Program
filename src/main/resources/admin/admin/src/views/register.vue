  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiaxiaojiaolian'" class="input-group">
			   <div class="label">教练姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaolianxingming" class="input" type="text" placeholder="教练姓名">
			   </div>
			 </div> -->
			<el-form-item label="教练姓名" class="input" v-if="tableName=='jiaxiaojiaolian'">
			...
			<el-form-item label="教练账号" class="input" v-if="tableName=='jiaxiaojiaolian'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiaxiaojiaolian'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jiaxiaojiaolian'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='jiaxiaojiaolian'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaxiaojiaolian'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='jiaxiaojiaolian'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaxiaojiaolian'" class="input-group">
			   <div class="label">通过率</div>
			   <div class="input-container">
			     <input v-model="ruleForm.tongguolv" class="input" type="text" placeholder="通过率">
			   </div>
			 </div> -->
			<el-form-item label="通过率" class="input" v-if="tableName=='jiaxiaojiaolian'">
			  <el-input v-model="ruleForm.tongguolv" autocomplete="off" placeholder="通过率"  />
			</el-form-item>
